...
#SBATCH --output=pkmBench-t%a.out        # standard output from job
#SBATCH --error=pkmBench-t%a.err        # standard error from job
##SBATCH --nodelist=tempest-epyc021

cd /home/b16q989/grad-school/parallel-processing/final-project
module load Julia
export OPENBLAS_NUM_THREADS=1
julia --threads $SLURM_ARRAY_TASK_ID pkmBenchmark.jl
