...
outputFileString = "results/t$(nThreads+1)/parallelKResultsSmall_t$(nThreads+1).mat"
outputVariableString = "parallelResultsSmall_t$(nThreads+1)"
#---------------------------------------------------
...
parallelResultsSmall = kmeans!(data_shuffled,combinedK.centers)

outputFile = matopen(outputFileString,"w")
write(outputFile,outputVariableString,parallelResultsSmall)
close(outputFile)
